...
function InstallZabbix() {
    ...
    sed -i -e "s/Server=127.0.0.1/Server=10.88.7.10/g" /etc/zabbix/zabbix_agentd.conf
    sed -i -e "s/ServerActive=127.0.0.1/ServerActive=10.88.7.10/g" /etc/zabbix/zabbix_agentd.conf
