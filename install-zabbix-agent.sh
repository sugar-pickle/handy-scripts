...
function InstallZabbix() {
    ...
    sed -i -e "s/Server=127.0.0.1/Server=192.168.0.0\/16/g" /etc/zabbix/zabbix_agentd.conf
    sed -i -e "s/ServerActive=127.0.0.1/ServerActive=192.168.0.26/g" /etc/zabbix/zabbix_agentd.conf
